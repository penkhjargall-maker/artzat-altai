  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-site mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <FadeIn key={stat.label} direction="up" className="text-center p-8 bg-white rounded-xl">
        ...
        <div className="max-w-site mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <FadeIn direction="left">
              <div className="aspect-video bg-neutral-parchment rounded-xl">
            ...
            <FadeIn direction="right">
              <div>
                ...
                <h2 className="text-3xl font-display font-bold text-neutral-deep mt-3 mb-4">
                  1998 онд байгуулагдсан
                </h2>
                <p className="text-neutral-charcoal leading-relaxed">
                  Арцат Алтайн Уулс ХХК нь Монголын хүнсний боловсруулах үйлдвэрлэлийн салбарт 25 гаруй жилийн туршлагатай. 
                  Бид чанар, аюулгүй байдал, амтыг эрхэмлэдэг. Монголын уугуул түүхий эдээс эхэлж, 
                  дэлхийн стандартад нийцсэн бүтээгдэхүүн үйлдвэрлэж байна.
                </p>
              </div>
            </FadeIn>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              <FadeIn key={value.title} direction="up" delay={i * 0.1}>
                <div className="flex items-center gap-6 p-6 bg-white rounded-xl border-b border-neutral-200"
                >
                  <div className="w-12 h-12 bg-neutral-offwhite rounded-lg flex items-center justify-center text-2xl">
                    {value.icon}
                  </div>
                  <div>
                    <h3 className="text-lg font-display font-semibold text-neutral-deep">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <FadeIn key={member.name} direction="up" delay={i * 0.1}>
                <div className="text-center p-8 bg-neutral-offwhite rounded-xl">
                  <div className="w-20 h-20 bg-neutral-parchment rounded-full flex items-center justify-center mx-auto mb-4">
                    <span className="text-2xl font-display font-bold text-brand-green">{member.initials}</span>
                  </div>
                  <h3 className="text-lg font-display font-semibold text-neutral-deep">{member.name}</h3>
      ...
      <section className="py-20 bg-neutral-offwhite">
        <div className="max-w-site mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeIn direction="up">
            <h2 className="text-3xl font-display font-bold text-neutral-deep mb-6">
